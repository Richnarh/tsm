...
//                .setParameter(Inventory._unitMeasurement, unitMeasurement)
    ...
    public Inventory getProduct(UnitMeasurement unitMeasurement) {
        return crudApi.getEm().createQuery("SELECT e FROM Inventory e WHERE e.companyBranch = :companyBranch", Inventory.class)
//                .setParameter(Inventory._unitMeasurement, unitMeasurement)
                .setParameter(Inventory._companyBranch, appSession.getCompanyBranch())
                .getResultStream().findFirst().orElse(null);
    }
    ...
    public PricePackage getPackage(String packageString) {
        return crudApi.getEm().createQuery("SELECT e FROM Packaging e WHERE e.packagingName=:packagingName", PricePackage.class)
//                .setParameter(PricePackage._packagingName, packageString)
                .getResultStream().findFirst().orElse(null);
    }
