...
import com.tsm.dto.StockDetails;
...
//                }
//                String qtyInShop = JUtils.objToString(currentRow.getCell(4));
        ...
        try
        {
            ...
            if(uploads){
                if(prepareOrder){
                    ...
                    purchaseOrder.setOrderCode(JUtils.generatePO());
                ...
                if(recieveOrder && purchaseOrder != null){
                    ...
                    stockReceipt.setReceiptNo(JUtils.generateIN());
                    stockReceipt.setRefNo(purchaseOrder.getOrderCode());
                    stockReceipt.setBatchNo(JUtils.generateCode());
